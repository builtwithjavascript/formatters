...
describe('datetime-formatters: datetime with parameter dateStyle "short" and timeStyle "short"', () => {
  ...
  describe('en-US', () => {
    ...
    it(`should return a date-time value formatted correctly`, () => {
      const result = datetimeFormatters.dateTime(dateStyle, timeStyle).format(inputValue)
...
describe('datetime-formatters: datetime with parameter dateStyle "full" and timeStyle "full"', () => {
  ...
  describe('en-US', () => {
    ...
    it(`should return a date-time value formatted correctly`, () => {
      const result = datetimeFormatters.dateTime(dateStyle, timeStyle).format(inputValue)
      const expected = 'Wednesday, March 25, 1970 at 12:11:03 AM Eastern Standard Time'
      expect(result).toEqual(expected)
    })
  })
  ...
  describe('fr-FR', () => {
    ...
    it(`should return a date-time value formatted correctly`, () => {
      const result = datetimeFormatters.dateTime(dateStyle, timeStyle).format(inputValue)
      const expected = 'mercredi 25 mars 1970 à 00:11:03 heure normale de l’Est nord-américain'
      expect(result).toEqual(expected)
    })
  })
